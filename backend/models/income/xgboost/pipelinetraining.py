...
class XGBoostIncomeModelTraining:
    def __init__(self, mlflowUri, dataPath, optunaRunNumber = 5):
        ...
        def objective(trial):
            ...
            pipeline = XGBoostPipeline(data=data, **params)
            ...
            with mlflow.start_run(nested=True):
                ...
                #mlflow.log_param("learning_rate", min_samples_split)
...
def main():
    ...
    XGBoostIncomeModelTraining(mlflowUri = mlflowUri, dataPath = dataPath)
